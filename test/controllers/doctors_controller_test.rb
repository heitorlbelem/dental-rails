...
class DoctorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doctor" do
    assert_difference("Doctor.count") do
      post doctors_url, params: { doctor: { expertise: @doctor.expertise, name: @doctor.name } }
    end
  ...
  test "should update doctor" do
    patch doctor_url(@doctor), params: { doctor: { expertise: @doctor.expertise, name: @doctor.name } }
