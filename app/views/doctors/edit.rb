module Views
  module Doctors
    class Edit < Components::Base
      ...
      def view_template
        title "Editing doctor"

        div(class: "md:w-2/3 w-full") do
          h1(class: "font-bold text-4xl") { "Editing doctor" }

          render Views::Doctors::Form.new(doctor: @doctor)

          a(href: helpers.doctor_path(@doctor), class: "w-full sm:w-auto text-center mt-2 sm:mt-0 sm:ml-2 rounded-md px-3.5 py-2.5 bg-gray-100 hover:bg-gray-50 inline-block font-medium") { "Show this doctor" }
